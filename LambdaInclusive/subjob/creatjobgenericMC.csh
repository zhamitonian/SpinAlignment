...
echo 'module put_parameter LambdaAna  output_filename\\'${filedir}'/hbk/'${dataType}'/genericMC_thrustSmaler0.8/'${RootName}''
echo 'module put_parameter LambdaAna isMCSample\\1'
echo 'module put_parameter LambdaAna rmMCTree\\1'
echo 'module put_parameter LambdaAna rmTree\\0'
...
echo 'histogram define '${filedir}'/hbk/'${dataType}'/genericMC_thrustSmaler0.8/'${fileName}'.hbk'
echo ''
