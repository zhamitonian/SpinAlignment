...
def main():
    ...
    rootFile = "./Ks_processed_with_pt_cut.root"
    output_dir = "./fit_results/data_fit_MC_constrain_with_pt_cut/"
    fitting_script = "./data_fitting_MC_constrain.py"

    vec_branches = ["Ks_M", "Ks_p", "Ks_costheta", "Ks_phi", "Ks_eff_correction", "Ks_z", "Ks_helicity_angle"]
    ...
    if first_run:
        submit_cmd(list(range(20,160)), if_lsf=True)
    else:
        refit_bins = [84,85]
