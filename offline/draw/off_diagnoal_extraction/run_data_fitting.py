...
def main():
    ...
    rootFile = "/gpfs/group/belle/users/wangz/data_gMC_belle1/PhiSpinAlignment_v2.1.3_data_svd2/reco.root"
    output_dir = "./fit_results/data_fit/"
    fitting_script = "./data_fitting.py"

    vec_branches = ["phi_M", "phi_p", "phi_costheta", "phi_phi", "phi_z", "phi_helicity_phi", "phi_helicity_angle"]
    ...
    if first_run:
        submit_cmd(list(range(300,400)), if_lsf=True)
    else:
        refit_bins = [100]
