...
def bin_by_bin(b2bii_path, basf_path, output_dir = "."):
    ...
    plot_bin_by_bin(";pt(rela. thrust);[MeV]", 40, 0, 2, "thrustFrame_pt", "trk_pt_toAxis_thrust")
    plot_bin_by_bin(";|cos#theta_{thrust}|;[1]", 50, 0, 1, "abs_cosTheta_thrust")
    """
...
if __name__ == "__main__":
    ...
    #bin_by_bin(b2bii_path, basf_path_rotated)
    ...
    basf_path = "/gpfs/group/belle2/users2022/wangz/other_rootFiles/SpinAlignment/basf2_hadronic_sel_validation/basf/basf.root"
