...
def bin_by_bin(b2bii_path, basf_path, output_dir = "."):
    ...
    df_b2bii = R.RDataFrame("track", b2bii_path)
...
if __name__ == "__main__":
    ...
    b2bii_path = "/gpfs/home/belle2/wangz/Work/SpinAlignment/steeringFile/hadronic_b2bii.root"
    bin_by_bin(b2bii_path, basf_path_rotated, "with_Evis_cut")

    b2bii_path = "without_Evis_cut/hadronic_b2bii.root"
    b2bii_path = "/gpfs/home/belle2/wangz/Work/SpinAlignment/steeringFile/test/hadronic_b2bii.root"
