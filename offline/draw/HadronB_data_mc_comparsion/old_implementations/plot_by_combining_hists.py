...
class combine_plot:
    ...
    def _get_data_gMC_hists(self, var):
        ...
        hist_roots_dir = self.hist_roots_dir 
    ...
    def include_QED_mc(self):
        ...
        df_diPhoton = df_diPhoton.Define("trk_cosTheta", "cos(trk_theta)") 
        df_diPhoton = df_diPhoton.Define("pho_cosTheta", "cos(pho_theta)")
    ...
    def start_plotting(self, hist_roots_dir ,output_dir):

        self.hist_roots_dir = hist_roots_dir
        ...
        var_list = ['nGood', 'nECL', 'nPhoton', 'Evis_cms', 'Esum_cms', 'PzSum_cms', 'Evis', 'Esum', 'PzSum',
                ...
                'cls_p', 'cls_theta', 'cls_phi', 'pho_p', 'pho_theta', 'pho_phi', 'trk_dr', 'trk_dz', 'PrimeVr', 'PrimeVz', 'trk_cosTheta', 'pho_cosTheta']
        ...
        for var in var_list:
            ...
            self.brush(MC_hists ,h_data, var , output_dir, leg_position= leg_position, normalize= False)

            normalized_output_dir = output_dir + "_normalized"
            os.makedirs(normalized_output_dir, exist_ok=True)
            self.brush(MC_hists ,h_data, var, normalized_output_dir, leg_position= leg_position, normalize= True)


if __name__ == "__main__":
    combiner = combine_plot()
    #hist_roots_dir = "./cut_Evis/hist_roots/"
    #output_dir = "./cut_Evis/images/combined_plots"
    hist_roots_dir = "./hist_roots/"
    output_dir = "./images/combined_plots"
    os.makedirs(output_dir, exist_ok=True)
    combiner.start_plotting(hist_roots_dir ,output_dir)
