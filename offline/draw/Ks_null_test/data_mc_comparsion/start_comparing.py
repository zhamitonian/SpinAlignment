...
def wrapper(flat_bin_idx):
    ...
    MC_rootFile = "../rootFiles/svd2_only_v2.3.3/sig_isSignal_v2.3.3.root"
    ...
    process_single_bin(flat_bin_idx, DEFAULT_KS_BINNING, comp_plots, 
                       ...
                       output_dir, DEFAULT_KS_WEIGHT_CONFIG, reweight_var="Ks_costheta")
