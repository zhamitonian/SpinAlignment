                                ...
                                PDFSpec("gauss2", "Ks_M", "gaussian",
                                        {
                                            #"mean":"mean_sig",
                                            "mean":(0.497,0.496,0.498),
                                            "sigma":(0.002, 0.0005, 0.01)
                                        }),
                                PDFSpec("bkg", "Ks_M", "chebychev",
                                #PDFSpec("bkg", "Ks_M", "polynomial",
                                        {"order":1})],
                                #model = "nsig[50000, 10000, 70000]*FCONV(Ks_M, sig, gauss) + nbkg[7000,0,300000]* bkg")    
                                #model = "nsig[50000, 10000, 200000]*(frac[0.85, 0.6, 0.98]*sig + gauss2) + nbkg[7000,0,300000]* bkg")    
                                model = "nsig[50000, 10000, 200000]*sig + nbkg[7000,0,300000]* bkg")
