...
def wrapper(flat_bin_idx):
    ...
    data_rootFile_dir = "../data_v2.3.2/output/"
    splot_rootFile_dir = data_rootFile_dir 
    MC_rootFile = "/gpfs/group/belle/users/wangz/data_gMC_belle1/KsSpinAlignment_v2.3.2_qqbar/exp55_reco_truth_matched.root" 
    output_dir = "./output/" 
    ...
    MC_weight_config = {"Ks": "Ks_weight", "pip": "pip_pid_weight", "pim": "pim_pid_weight"}

    process_single_bin(flat_bin_idx, binning_config, var_config, data_rootFile_dir, splot_rootFile_dir, MC_rootFile, output_dir, MC_weight_config)
    ...
    if len(sys.argv) > 1:
        ...
        if sys.argv[1] == "--gen_summary":
            ...
            generate_latex_document(binning_config, plot_labels, var_labels, title,
                                    ...
                                    comparison_plot_dir= "./output/",
                                    valid_bins= list(range(60, 130)))
        else:
            print("Usage:")
