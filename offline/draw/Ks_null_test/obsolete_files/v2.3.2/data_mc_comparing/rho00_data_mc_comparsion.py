...
class comparing:
    ...
    def start_plotting(self, var_config, weight_config = None):
...
def process_single_bin(flat_bin_idx, binning_config, var_config, data_rootFile_dir, splot_rootFile_dir, mc_rootFile, batch_output_dir, MC_weight_config = None):
    """
    ...
    MC_weight_config : dict
        Configuration for MC weighting for particle name:
        {"Ks": "Ks_weight", "pip": "pip_pid_weight", "pim": "pim_pid_weight"}
    """
    import sys
    ...
    '''
    #df_mc_bin.Snapshot("event", "test.root")
