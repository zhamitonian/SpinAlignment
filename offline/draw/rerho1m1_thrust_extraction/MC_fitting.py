...
def wrapper_func(tree, output_dir, log_file, bin_fit_range, binned_fit):
    ...
    dataset_config = DatasetConfig(binned_fit= binned_fit, weight_branch="phi_weight", target_branch=["phi_M"], perform_splot=False)
...
def fit(): 
    quick_fit = QUICK_FIT(wrapper_func, {"phi_z": (20, 0, 1), "phi_thrust_helicity_phi": (20, 0, pi/2)})
