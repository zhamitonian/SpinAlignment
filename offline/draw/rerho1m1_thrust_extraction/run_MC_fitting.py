...
def main():
    ...
    rootFile = "reco_output_qqbar.root"
    output_dir = "./fit_results/MC_fit/"
    fitting_script = "./MC_fitting.py"

    vec_branches = ["phi_M", "phi_p", "phi_costheta", "phi_phi", "phi_z", "phi_helicity_phi", "phi_helicity_angle", "phi_weight", "phi_thrust_helicity_costheta", "phi_thrust_helicity_phi"]
