...
def main():
    ...
    rootFile = "/gpfs/group/belle/users/dues/data_gMC_belle1/rho770SpinAlignment_v1.0.0_qqbar_svd2_duxs/reco_truth_match_from_reco_func.root"
    output_dir = "./fit_results/MCsig_fit/"
    fitting_script = "./MCsig_fitting.py"

    vec_branches = ["rho_M", "rho_p", "rho_costheta", "rho_phi", "rho_z", "rho_helicity_phi", "rho_helicity_angle"]
    ...
    if first_run:
        submit_cmd(list(range(60,180)), if_lsf=True)
    else:
        refit_bins = [65]
